    ...
    <div class="contant">
        ...
        <div class="xinxi clearfix">
            ...
            <div class="left">
                ...
                <ul>
                    <li>
                        <div class="img"><img src="${pageContext.request.contextPath}/images/04-search_03.jpg" width="300px" alt=""></div>
                        <div class="text1">
                        ...
                        <div class="price">
                            ...
                            <p><a href="${pageContext.request.contextPath}/route_detail.jsp">查看详情</a></p>
                        </div>
                    </li>
