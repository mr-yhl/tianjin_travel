            ...
            <table class="table">
                ...
                <tr class="table-bordered">
                    <td width="180" width="40%">
                        ...
                        <img src="${pageContext.request.contextPath}/images/04-search_03.jpg" width="170" height="100">
                    </td>
                    <td width="30%">
                ...
                <tr class="table-bordered">
                    <td width="180" width="40%">
                        <input type="hidden" name="id" value="22">
                        <img src="${pageContext.request.contextPath}/images/04-search_09.jpg" width="170" height="100">
                    </td>
                    <td width="30%">
