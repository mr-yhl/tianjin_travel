            ...
            <c:if test="${not empty cart.cartItemMap}">
                <div class="row">
                    ...
                    <div style="margin:0 auto; margin-top:20px">
                        <div style="font-weight: bold;font-size: 15px;margin-bottom: 10px">商品数量：${cart.totalCount}</div>
                        <table class="table">
                            <tbody>
                            ...
                            <c:forEach items="${cart.cartItemMap}" var="entry">
                                <tr class="table-bordered">
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/CartServlet?action=delCartItem&rid=${entry.key}" class="delete">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
